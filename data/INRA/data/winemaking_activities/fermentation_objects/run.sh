...
curl "https://docs.google.com/spreadsheets/d/1nhBnoWhDfDakL-ucY-STdRbDzhgH0yZSEeebwYR88M0/gviz/tq?tqx=out:csv&gid=0" | ../../../../bin/my-tarql "-d , --stdin" ../../../../../model/prefixes.ttl fermentationObservations.tarql > rdf/fermentationObservations.ttl
