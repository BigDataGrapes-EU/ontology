...
INRA :
(Can we use osgeom as presented in this example : https://www.w3.org/TR/eo-qb/#GeoSPARQL)
...
INRA :  We have change the representation by using gmlLiteral
...
* TODO FinFermentationsAlcoolique_transf_parsed.ttl
