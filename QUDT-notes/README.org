...
:CUSTOM_ID: Resources
:END:
Saved in [[https://drive.google.com/drive/u/0/folders/1Is0Zh8jT5H0eCPf8F-tXQW8ZZdpWUWNv][Google Drive WP3\background\QUDT]]
- http://www.openphacts.org/specs/units/ 
  ...
  - OpenPHACTS is an aggregation of lifeSci and pharmaceutical data, so it's relevant.
    ...
    They have examples defining ~ops:GramPerLiter~ and ~ops:MilligramPerDeciliter~ (with ~rdf:type qudt:MassPerVolumeUnit~)
